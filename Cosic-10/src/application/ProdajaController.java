...
public class ProdajaController {
	...
	@FXML
	private ComboBox<Artikl> artikl;

	@FXML
	private ComboBox<Korisnik> korisnik;

	@FXML
	private DatePicker datum;

	@FXML
	private TableView<Prodaja> tablicaProdaja;

	@FXML
	private TableColumn<Prodaja, Artikl> stupacArtikl;

	@FXML
	private TableColumn<Prodaja, Korisnik> stupacKorisnik;

	@FXML
	private TableColumn<Prodaja, LocalDate> stupacDatum;


	@SuppressWarnings("unchecked")
	public void filterProdaje() throws Exception, BazaPodatakaException {
		try {
			dataProdaja = FXCollections.observableList(BazaPodataka.dohvatiProdajuPremaKriterijima(new Prodaja(artikl.getValue(), korisnik.getValue(), datum.getValue())));
	...
	@FXML
	public void prikaziEkranZaProdaju() throws Exception, BazaPodatakaException {
	...
	@FXML
	public void prikaziEkranZaUnosProdaje() throws Exception, BazaPodatakaException {
	...
	public void initialize() throws SQLException, IOException, BazaPodatakaException {
		List<Artikl> listaArtikala = BazaPodataka.dohvatiArtikle(null);
		List<Korisnik> listaKorisnik = BazaPodataka.dohvatiKorisnike(null);
		artikl.getItems().addAll(listaArtikala);
		korisnik.getItems().addAll(listaKorisnik);
