...
public class UnosProdaje {
	...
	public void UnosProdajeFunk() throws BazaPodatakaException, IOException {
		BazaPodataka.pohraniNovuProdaju(new Prodaja(artikl.getValue(), korisnik.getValue(), datum.getValue()));
